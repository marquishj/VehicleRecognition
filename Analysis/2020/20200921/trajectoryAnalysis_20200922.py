...
if __name__ == '__main__':
    ...
    # file_path="D:\\data\\私家车\\纯电\\"
    # file_path="D:\\data\\私家车\\混动\\"
    # file_path="D:\\data\\网约车\\"
    # file_path="D:\\data\\出租车\\"
    # file_paths="D:\\data\\私家车\\纯电\\","D:\\data\\私家车\\混动\\","D:\\data\\网约车\\","D:\\data\\出租车\\"
    file_paths="F:\\sql data\\classifer_car_data\\example\\data\\私家车\\纯电\\",\
               "F:\\sql data\\classifer_car_data\\example\\data\\私家车\\混动\\",\
               "F:\\sql data\\classifer_car_data\\example\\data\\网约车\\",\
               "F:\\sql data\\classifer_car_data\\example\\data\\出租车\\"
    file_suffixs=['pcev','pchev','didi','taxi']

    # for (file_suffix,file_path) in zip(file_paths,file_suffixs):
    n=0
    for file_path in file_paths:
        ...
        sys.stdout =Logger('F:\\sql data\\classifer_car_data\\result+{}'.format(file_suffixs[n])+'.txt')
        # sys.stdout =Logger('D:\\20200923\\HJ\\result.txt')
        # sys.stdout =Logger('C:\\20200923\\HJ\\result.txt')
