...
if __name__ == '__main__':
    ...
    for file_path in file_paths:
        ...
        sys.stdout =Logger('D:\\result-20201014\\HJ\\result_{}'.format(file_suffixs[n])+'.txt')
        sys.stdout =Logger('D:\\20201014\\HJ\\result_{}'.format(file_suffixs[n])+'.txt')
        sys.stdout =Logger('C:\\result-20201014\\HJ\\result_{}'.format(file_suffixs[n])+'.txt')
